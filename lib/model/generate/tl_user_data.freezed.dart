...
abstract class _$$TLUserDataImplCopyWith<$Res>
  ...
  factory _$$TLUserDataImplCopyWith(
    _$TLUserDataImpl value,
    $Res Function(_$TLUserDataImpl) then,
...
class __$$TLUserDataImplCopyWithImpl<$Res>
  ...
  __$$TLUserDataImplCopyWithImpl(
    _$TLUserDataImpl _value,
    $Res Function(_$TLUserDataImpl) _then,
  ) : super(_value, _then);
...
class _$TLUserDataImpl implements _TLUserData {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                  other.selectedCheckBoxIconData,
                  selectedCheckBoxIconData,
                ) ||
                other.selectedCheckBoxIconData == selectedCheckBoxIconData) &&
            const DeepCollectionEquality().equals(
              other._earnedCheckBoxIcons,
              _earnedCheckBoxIcons,
            ) &&
  ...
  Map<String, dynamic> toJson() {
    return _$$TLUserDataImplToJson(this);
  }
}
...
abstract class _TLUserData implements TLUserData {
  ...
  @override
  Map<String, List<String>> get earnedCheckBoxIcons; // カスタムアクセントカラー (null の場合はデフォルトのアクセントカラーを使用)
  @override
