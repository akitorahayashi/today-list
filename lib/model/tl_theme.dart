...
class TLThemeData {
  ...
  // nice apps系
  final Color otherAppsCardColor;
  ...
  TLThemeData({
    ...
    // nice apps系
    required this.otherAppsCardColor,
...
final List<TLThemeData> tlThemeDataList = [
  TLThemeData(
    ...
    // nice apps系
    otherAppsCardColor: const Color.fromRGBO(255, 192, 97, 1),
  ...
  TLThemeData(
    ...
    // nice apps系
    otherAppsCardColor: const Color.fromRGBO(225, 163, 102, 1),
  ...
  TLThemeData(
    ...
    // nice apps系
    otherAppsCardColor: const Color.fromRGBO(129, 221, 234, 1),
