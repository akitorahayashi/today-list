...
//                                 "stringWorkspaces": json.encode(tlworkspaces),
//                               });
...
//       } else {
//         tlworkspaces = json.decode(mapUserData["stringWorkspaces"]);
//         workspaceCategories = TLCategory.jsonToCategoryArray(
//             jsonCategoryArrayData: mapUserData["workspaceCategories"]);
//       }
//       // current workspace
//       currentWorkspace = TLWorkspace.fromJson(
//           tlworkspaces[currentWorkspaceCategoryId]![currentWorkspaceIndex]);
//       // バイブレーション
