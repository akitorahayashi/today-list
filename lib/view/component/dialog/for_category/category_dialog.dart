...
class AddOrEditCategoryDialog extends HookWidget with TLBaseDialogMixin {
  final String title;
  final String buttonText;
  final ValueNotifier<String?> selectedBigCategoryID;
  final ValueNotifier<String> enteredCategoryTitle;
  final TLWorkspace currentWorkspace;
  final void Function(String newCategoryName, String? selectedBigCatID)
      onSubmit;
      ...
      content: Column(
        ...
        children: [
          ...
          _ActionButtons(
            ...
            onSubmit: () => onSubmit(
              enteredCategoryTitle.value,
              selectedBigCategoryID.value,
            ),
          ),
        ],
      ),
