...
let tlThemeColor: [String: TLThemeColor] = [
    "Sun Orange": TLThemeColor(
    ...
    "Lime Green": TLThemeColor(gradientOfTopBar: LinearGradient(
        gradient: Gradient(colors: [
    ...
    "Marine Blue": TLThemeColor(gradientOfTopBar: LinearGradient(
        gradient: Gradient(colors: [
